    ...
    return (
      <div>
        ...
        <ul className="hoglist">
          <BabyHog eyeColor={this.state.eyeColor} babyPig={offspring[0]}/>
          <BabyHog eyeColor={this.state.eyeColor} babyPig={offspring[1]}/>
          <BabyHog eyeColor={this.state.eyeColor} babyPig={offspring[2]}/>
        </ul>
...
//         <ul className="hoglist">
//           <BabyHog eyeColor={this.state.eyeColor} baby={offspring[0]}/>
//           <BabyHog eyeColor={this.state.eyeColor} baby={offspring[1]}/>
//           <BabyHog eyeColor={this.state.eyeColor} baby={offspring[2]}/>
//         </ul>
